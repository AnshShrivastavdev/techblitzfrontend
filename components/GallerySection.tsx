...
export function GallerySection() {
  return (
    <section id="gallery" className="py-24 border-t border-white/10 bg-black">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {GALLERY_CARDS.map((card, idx) => (
            <div
              key={idx}
              className="rounded-xl border border-white/10 bg-neutral-950/80 p-6 flex flex-col justify-between hover:border-white/30 transition-all duration-300 group backdrop-blur-md"
            >
              <div>
                {/* Top Telemetry Header */}
                <div className="flex items-center justify-between text-[11px] font-mono text-neutral-500 mb-4 pb-2.5 border-b border-white/10">
                ...
                <div className="h-44 rounded-lg bg-neutral-900/50 border border-dashed border-white/15 flex flex-col items-center justify-center text-neutral-500 mb-5 group-hover:border-white/30 transition-colors relative overflow-hidden">
