...
function lerpColor(base: { r: number; g: number; b: number; a: number }, active: { r: number; g: number; b: number; a: number }, t: number): string {
...
export function KineticGrid({
  ...
  return (
    <div
      className={cn('relative w-full min-h-screen overflow-x-hidden', className)}
      style={{
        backgroundColor: globalColor === 'monochrome' ? '#000000' : '#020306',
      }}
    >
      <canvas
        ref={canvasRef}
