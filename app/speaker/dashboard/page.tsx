...
export default function DashboardSpeaker() {
  ...
  const [activeTab, setActiveTab] = useState<'sessions' | 'attendees'>('sessions');
  ...
  const handleStatusChange = (workshopId: string, newStatus: Workshop['status']) => {
                  ...
                  >
                    <div className="dash-card" style={{ height: '100%', margin: 0 }}>
                      ...
                      <div className="dash-card__meta">
                        <div>
                          <Clock size={14} /> Duration: {ws.minAttendanceMinutes * 3 || 90} min
                        </div>
                        <div>
                          <Calendar size={14} />{' '}
